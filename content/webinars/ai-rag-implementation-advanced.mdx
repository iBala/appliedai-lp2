...
**Introduction to RAG**
Hey, folks, happy Saturday. In this session, [Pavan Mantha](https://www.linkedin.com/in/kameshwara-pavan-kumar-mantha-91678b21/) from [Orbcomm](https://www.orbcomm.com/) takes us through the an advanced session on how to implement Retrieval-Augmented Generation. This is a follow up session to our f[Foundational RAG session](https://www.appliedai.club/webinars/ai-rag-technical-foundation). We highly recommend you go through that first.
